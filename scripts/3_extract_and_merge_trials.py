...
# %%
dfs = []
for path in tqdm(paths, desc="Reading Dataset"):
...
# %%
df.to_parquet('data/final/steinmetz_day1.parquet')
df.to_csv('data/final/steinmetz_day1.csv')
df.to_csv('data/final/steinmetz_day1_compressed.csv', compression="gzip")
